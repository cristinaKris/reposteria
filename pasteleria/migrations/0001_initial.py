# Generated by Django 5.2.8 on 2025-11-23 23:20
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('calificacion', models.IntegerField(blank=True, default=None, max_length=3, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('descripcion', models.CharField(blank=True, default='Sin descripción', max_length=50, null=True)),
        ...
        migrations.AddField(
            model_name='pedido',
            name='usuario',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='pedidos', to='pasteleria.usuario'),
        ),
        migrations.CreateModel(
            name='PASTEL_ESTABLECIDO',
            fields=[
                ('idEstablecido', models.OneToOneField(limit_choices_to={'ESTABLECIDO', 'tipoPastel'}, on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='pasteleria.pastel')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('idPersonalizado', models.OneToOneField(limit_choices_to={'PERSONALIZADO', 'tipoPastel'}, on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='pasteleria.pastel')),
                ('relleno', models.CharField(choices=[('DURAZNO', 'durazno con nuez'), ('ALMENDRA', 'crema de almendras'), ('GANACHE', 'ganache de Belga')], max_length=20)),
                ('tamano', models.CharField(choices=[('CHICO', 'chico'), ('MEDIANO', 'mediano'), ('GRANDE', 'grande')], max_length=20)),
                ('decoracion', models.CharField(choices=[('FLORES', 'flores naturales comestibles'), ('FONDANT', 'fondant'), ('FRUTA', 'fruta')], max_length=20)),
                ('sabor', models.CharField(choices=[('CHOCOLATE', 'chocolate'), ('VAINILLA', 'vainilla'), ('MATCHA', 'matcha')], max_length=20)),
            ],
        ),
    ]
