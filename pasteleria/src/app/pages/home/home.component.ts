...
export class HomeComponent {
  ...
  productosConDescuento: {name: string; description: string; price: number; img:string}[] = [
    { name: "Croissant", description: "Delicioso croissant que muchos llaman la especialidad de la casa.", price: 15, img: "assets/img/croissant.png" },
    { name: "Concha", description: "El clásico pan dulce suave con una costra de azucar encima.", price: 15, img: "assets/img/concha.png" },
    { name: "Trenza", description: "Trenza de pan con azúcar sin relleno.", price: 15, img: "assets/img/trenza.png" },
